...
- **Google Analytics (GA4)** — every page carries the gtag.js snippet for Measurement ID `G-5C9PJWXV7H` (property "jackzhaojin.com", web stream `https://www.jackzhaojin.com`) as the first thing after the viewport meta in `<head>`. Add it to any new page.
